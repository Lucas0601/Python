...
# O que é conjunto, Método de união, Método de intersecção, Método de diferença
# Método de diferença simétrica, Remoção de duplicidade de listas utilizando conjuntos
